...
export default function Signup() {
  ...
  const signupFormHandler = async (e) => {
    ...
    if (fullname.length < 3) {
      console.error("Full name must be at least 3 characters long.");
      return;
    }
  ...
  return (
    <>
      <div className="flex min-h-full max-w-sm mx-auto border mt-24 flex-1 flex-col justify-center px-6 py-8 lg:px-8">
          ...
          <form className="space-y-2" action="#" method="POST">
            ...
            <div>
              ...
              <select
                name="role"
                id="role"
                ref={roleRef} // Attach the ref to the select element
